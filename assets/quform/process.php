 ...
 * );
 */
$config['recipients'] = 'danielahermosillohdz@gmail.com';
 ...
 * $config['from'] = '%email%';
 */
$config['from'] = array('danielahermosillohdz@gmail.com' => 'Web de Dario Anelli');
 ...
 * Validators: Required
 */
$title = new Quform_Element('title', 'Title');
...
$upload->getFileUploadValidator()->setAllowedExtensions(array('gif', 'jpeg', 'jpg', 'png', 'docx', 'xlsx', 'pdf', 'pptx'));
//$form->addElement($upload);

/**
 * Configure the Google reCAPTCHA V2 element

*/
$recaptcha = new Quform_Element('g-recaptcha-response', 'reCAPTCHA');
$recaptcha->addValidator('required');
$recaptcha->addValidator('recaptcha', array('secretKey' => '6LeiLq8cAAAAADrbP0AlK2-SRY5Oc89p7drXTEzn'));
