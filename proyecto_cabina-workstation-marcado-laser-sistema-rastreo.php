...
<html lang="<?php echo $lang['language']?>"><head>
  ...
  <link rel="canonical" href="http://www.solinda.com.mx/proyecto_cabina-workstation-marcado-laser-sistema-rastreo.php?lang=es">
  <link rel="alternate" hreflang="en" href="http://www.solinda.com.mx/proyecto_cabina-workstation-marcado-laser-sistema-rastreo.php?lang=en">
  ...
  <div id="wrapper">
    ...
    <div class="main-content">
      ...
      <div class="wrapper-hero__project-each">
        <section class="page-hero" class="about-hero image-as-background" style="background-image: url('/img/projects/workstation-marcado-laser/proy_workstation-marcado-laser-01.png');">
            <div class="container">
              <h6 class="animate fadeInLeft delay-400"><span class="dash">—</span><?php echo $lang['Proyecto']?></h6>
              <h2 class="hero-title animate fadeInLeft delay-600"><?php echo $lang['Workstations para Marcado Láser con Sistema de Rastreo']?></h2>
            </div>
        ...
        <ul class="project__tags">
          ...
          <div class="project__tags__inner">
            <li class="project__tag" style="">
              ...
              <div class="project__tag__value"><?php echo $lang['Empresa']?></div>
            </li>
            <li class="project__tag" style="">
              <div class="project__tag__name"><?php echo $lang['A&ntildeo']?></div>
              <div class="project__tag__value">2023</div>
            </li>
          </div>
        </ul>
      </div>
      ...
      <div class="project-each__lg-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in">
            <img src="/img/projects/cabina-3d/solinda-cabina-3d__first.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
        ...
        <div class="container">
          <div class="column_container ">
              <div class="col">  
                ...
                <p class="item_2 rich-paragraph"><?php echo $lang['Solinda fue contratada para desarrollar este proyecto de detección de brackets y soportes soldados sobre los paneles laterales frontales de montacargas. El sistema posee visualización 3d de posición y de presencia y ausencia de soldadura, así como su correcta aplicación.']?></p></br></br>
                <p class="item_2"><?php echo $lang['Nuestro equipo realizó la fabricación y la integración de esta estación de inspección para verificar la existencia de componentes soldados (brackets), así como la existencia de soldaduras. La estructura de la estación fue hecha con PTR de 2”, placa base de acero a36, guarda perimetral de algulo y lámina calibre 12. Además, rieles guía de entrada.']?></p></br></br>
                <p class="item_2"><?php echo $lang['El sistema posee visualización 3d de posición y de presencia y ausencia de soldadura. Incorpora además un sistema montado sobre rieles guías lineales anclados sobre el suelo; un sistema de localización neumático marca SMC; equipo de control PLC modelo IQR y una pantalla HMI GOT de 7” de marca Mitsubishi; botonería Allen Bradley; interlocks de seguridad marca Omron; sensores fotoreflectivos marca Keyence.']?></p></br></br>
                <p class="item_2"><?php echo $lang['Además, está integrado con dos cámaras de visión 3d marca Keyence montadas sobre un sistema de guías lineales marca THK y accionadas por un servomotor marca Mitsubishi modelo HG-KR23K y tornillo de bolas marca Sic Marking.']?></p></br></br>
                <p class="item_2"><?php echo $lang['Fueron fabricados de igual manera 8 carros de transporte para piezas izquierda y derecha con base de estructura de PTR, incluyendo 4 ruedas giratorias con freno y placas de localización. El sistema finaliza con un marcado por percusión en una cabina con iluminación y control de accesos.']?></p></br></br>
              </div>
          </div> 
        </div> 
      </section>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/cabina-3d/solinda__cabina-3d-01.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/cabina-3d/solinda__cabina-3d-02.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/cabina-3d/solinda__cabina-3d-03.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/cabina-3d/solinda__cabina-3d-04.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/cabina-3d/solinda__cabina-3d-05.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
