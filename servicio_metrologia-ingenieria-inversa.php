...
<html lang="<?php echo $lang['language']?>"><head>
  ...
  <link rel="canonical" href="http://www.solinda.com.mx/servicio_metrologia-ingenieria-inversa.php?lang=es">
  <link rel="alternate" hreflang="en" href="http://www.solinda.com.mx/servicio_metrologia-ingenieria-inversa.php?lang=en">
      ...
      <div class="main-content">
        ...
        <div class="wrapper-hero__service-each">
          <section class="page-hero" class="about-hero image-as-background">
              <div class="container text-center">
                ...
                <h2 class="hero-title animate fadeInLeft delay-600"><?php echo $lang['Metrología e Ingeniería Inversa']?></h2>
              </div>
        ...
        <div class="service-each__hero-img">
          <div class="container">
            <span class="animate fadeInLeft delay-800">
              <img src="/img/service-each/metrology/solinda_metrology_cover.jpg" class="img-fluid" alt="Solinda — Metrología e Ingeniería Inversa ">
            </span>
          </div>
        </div>
        ...
        <!--<div class="service-page-cover-img animate fadeInLeft delay-800">
          ...
          <div class="slider">
            ...
            <div class="swiper-slide"><img src="/img/service-each/metrology/solinda_metrology_s_01.jpg" alt="Solinda" class="img-fluid"></div>
            <div class="swiper-slide"><img src="/img/service-each/metrology/solinda_metrology_s_02.jpg" alt="Solinda" class="img-fluid"></div>
            <div class="swiper-slide"><img src="/img/service-each/metrology/solinda_metrology_s_03.jpg" alt="Solinda" class="img-fluid"></div>
            <div class="swiper-slide"><img src="/img/service-each/metrology/solinda_metrology_s_04.jpg" alt="Solinda" class="img-fluid"></div>
            <div class="swiper-slide"><img src="/img/service-each/metrology/solinda_metrology_s_05.jpg" alt="Solinda" class="img-fluid"></div>
            <div class="swiper-slide"><img src="/img/service-each/metrology/solinda_metrology_s_06.jpg" alt="Solinda" class="img-fluid"></div>
