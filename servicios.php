    ...
    <!--END HEADER -->
      ...
      <div class="main-content">
        ...
        <div class="wrapper-hero">
          <section class="page-hero" class="about-hero image-as-background" style="background-image: url(/img/services/services__cover.jpg);"">
              <div class="container">
                <h6 class="animate fadeInLeft delay-400"><span class="dash">—</span><?php echo $lang['Nuestros Servicios']?></h6>
                <h2 class="hero-title animate fadeInLeft delay-600"><?php echo $lang['Servicios a la Industria']?></h2>
                <p class="p-cover animate fadeInLeft delay-800" title="Click to see more"><?php echo $lang['Con cerca de 10 años de experiencia, somos expertos en dar soluciones a la industria.']?></p>
              </div>
      ...
      <div id="services-page">    
        ...
        <section id="services">
          <div class="wrappie">
            <article class="card_">
              <aside class="card__image-container" style="background-image: url(/img/services/service_auto.jpg);">
                <img class="card__image" src="/img/services/service_auto.jpg">
              </aside>
      
              <section class="card__contents">
                <header class="card__header">
                  <h3 class="card__title"><?php echo $lang['Automatización']?></h3>
                </header>
      
                <section class="card__body">
                  <p class="card__p"><?php echo $lang['En Solinda, nuestra especialidad son las soluciones en automatización de procesos para la industria. Nuestra experiencia garantiza aumentar la productividad de nuestros clientes y así, incrementar sus ganancias.']?></p>
        
                  <ul class="card__list">
                    <li class="card__list-item"><?php echo $lang['Programación']?>
                      <span class="card__list-description"><?php echo $lang['PLC, HMI, Sistemas de Visión']?></span>
                    </li>
                    <li class="card__list-item"><?php echo $lang['Integración de Robots y Equipos Especiales']?>
                      <span class="card__list-description"><?php echo $lang['Soldadura, Vibración, Visión, Escaneo']?></span>
                    </li>
                    <li class="card__list-item"><?php echo $lang['Armado de Tableros']?></li>
                    <li class="card__list-item"><?php echo $lang['Conveyors y Líneas de Ensamble']?></li>
                  </ul>
                  <div class="cta_container">
                    <a class="cta" href="servicio_automatizacion.php" title="discover" target="_self">
                      <span><?php echo $lang['Saber más']?></span><i class="arrow right"></i>
                    </a>
                  </div>
                </section>
              </section>
          ...
          <div class="wrappie">
            <article class="card_">
              <aside class="card__image-container"  style="background-image: url(/img/services/service_disp.jpg);">
                <img class="card__image" src="/img/services/service_disp.jpg">
              </aside>
      
              <section class="card__contents">
                <header class="card__header">
                  <h3 class="card__title"><?php echo $lang['Dispositivos']?></h3>
                </header>
      
                <section class="card__body">
                  <p class="card__p"><?php echo $lang['Somos además expertos en dispositivos en Solinda. Nuestro equipo de ingenieros trabaja con precisión y nosotros mismos elaboramos cada pieza, asegurando productos de calidad inigualable.']?></p>
        
                  <ul class="card__list">
                    <li class="card__list-item">Checking Fixtures
                    </li>
                    <li class="card__list-item">Pallets</li>
                    <li class="card__list-item">Gauges</li>
                    <li class="card__list-item">Laser Cutting</li>
                  </ul>
                  <div class="cta_container">
                    <a class="cta" href="servicio_dispositivos-herramientas.php" title="discover" target="_self">
                      <span><?php echo $lang['Saber más']?></span><i class="arrow right"></i>
                    </a>
                  </div>
                </section>
          ...
          <div class="wrappie">
            <article class="card_">
              <aside class="card__image-container"  style="background-image: url(/img/services/service_metr.jpg);">
                <img class="card__image" src="/img/services/service_metr.jpg">
              </aside>
      
              <section class="card__contents">
                <header class="card__header">
                  <h3 class="card__title"><?php echo $lang['Metrología e Ingeniería Inversa']?></h3>
                </header>
      
                <section class="card__body">
                  <p class="card__p"><?php echo $lang['Nuestro Laboratorio de Metrología posee equipamiento completo de medición de última generación. Estamos en proceso de certificación, aseguramos resultados de alta precisión.']?></p>
        
                  
                  <div class="cta_container">
                    <a class="cta" href="servicio_metrologia-ingenieria-inversa.php" title="discover" target="_self">
                      <span><?php echo $lang['Saber más']?></span><i class="arrow right"></i>
                    </a>
                  </div>
                </section>
          ...
          <div class="wrappie">
            <article class="card_">
              <aside class="card__image-container" style="background-image: url(/img/services/service_ref.jpg);">
                <img class="card__image" src="/img/services/service_ref.jpg">
              </aside>
      
              <section class="card__contents">
                <header class="card__header">
                  <h3 class="card__title"><?php echo $lang['Refaccionamiento']?></h3>
                </header>
      
                <section class="card__body">
                  <p class="card__p"><?php echo $lang['Elaboramos refaccionamiento de alta precisión y nos encargamos de la manufactura de las partes en nuestra planta equipada con maquinaria de última generación.']?></p>
        
                  <div class="cta_container">
                    <a class="cta" href="servicio_refaccionamiento.php" title="discover" target="_self">
                      <span><?php echo $lang['Saber más']?></span><i class="arrow right"></i>
                    </a>
                  </div>
                </section>
          ...
          <div class="wrappie">
            <article class="card_">
              <aside class="card__image-container" style="background-image: url(/img/services/service_rack.jpg);">
                <img class="card__image" src="/img/services/service_rack.jpg">
              </aside>
      
              <section class="card__contents">
                <header class="card__header">
                  <h3 class="card__title">Racks</h3>
                </header>
      
                <section class="card__body">
                  <p class="card__p"><?php echo $lang['Somos igualmente especialistas en la fabricación de racks, incluso automatizados. Elaboramos todo tipo de racks para todo tipo de empresa.']?></p>
        
                  <div class="cta_container">
                    <a class="cta" href="servicio_racks.php" title="discover" target="_self">
                      <span><?php echo $lang['Saber más']?></span><i class="arrow right"></i>
                    </a>
                  </div>
                </section>
