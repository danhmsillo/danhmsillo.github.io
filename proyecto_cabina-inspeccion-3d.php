...
<html lang="<?php echo $lang['language']?>"><head>
  ...
  <link rel="canonical" href="http://www.solinda.com.mx/proyecto_cabina-inspeccion-3d.php?lang=es">
  <link rel="alternate" hreflang="en" href="http://www.solinda.com.mx/proyecto_cabina-inspeccion-3d.php?lang=en">
  ...
  <div id="wrapper">
    ...
    <div class="main-content">
      ...
      <div class="wrapper-hero__project-each">
        <section class="page-hero" class="about-hero image-as-background" style="background-image: url('/img/projects/cabina-3d/solinda-cabina-3d__cover.jpg');">
            <div class="container">
              <h6 class="animate fadeInLeft delay-400"><span class="dash">—</span><?php echo $lang['Proyecto']?></h6>
              <h2 class="hero-title animate fadeInLeft delay-600"><?php echo $lang['Cabina de Inspección 3D']?></h2>
            </div>
        ...
        <ul class="project__tags">
          ...
          <div class="project__tags__inner">
            <li class="project__tag" style="">
              ...
              <div class="project__tag__value"><?php echo $lang['Fabricante Americano de Montacargas']?></div>
            </li>
            <li class="project__tag" style="">
