...
<html lang="<?php echo $lang['language']?>"><head>
  ...
  <link rel="canonical" href="http://www.solinda.com.mx/business_area_racks.php?lang=es">
  <link rel="alternate" hreflang="en" href="http://www.solinda.com.mx/business_area_racks.php?lang=en">
  ...
  <div id="wrapper">
    ...
    <div class="main-content">
      ...
      <div class="wrapper-hero__project-each">
        <section class="page-hero" class="about-hero image-as-background" style="background-image: url('/img/business-areas/SOLINDA_business-areas-racks.jpg');">
            <div class="container">
              <h6 class="animate fadeInLeft delay-400"><span class="dash">—</span><?php echo $lang['Business Areas']?></h6>
              <h2 class=" uppercase text-white margin-two-top accent-font animate fadeInLeft delay-600"><?php echo $lang['Racks']?></h2>
            </div>
        </section>
      </div>
      <!-- END HERO -->
      ...
      <div class="bg-white"> 
        ...
        <section id="business-areas-page" class="text-left">
          <div class="grid-container-sol section padding-6-rem-bottom margin-three-top animation-parent">
            <div>
              <span class="mask notViewed animBlock " data-position="up"><h6 class=""><?php echo $lang['Nuestra Definición']?></h6></span>
              <div class="item_2">
                <h3 class= margin-20px-top>
                  <span class="highlight"><?php echo $lang['Solinda']?></span><?php echo $lang[' es referente en la industria por sus inigualables resultados']?>
                </h3>
                <p class="rich-paragraph"><?php echo $lang['En Solinda, somos expertos en diseño y fabricación de racks. Proveemos soluciones en racks de piezas estampadas, plásticas exteriores y de vista, así como cristales y panorámicos, entre otros. También desarrollamos dunnage’s plásticos y texturizados, y ofrecemos acabados de pintura horneada y plastidip.']?> </p>
                </br>
              </div>
            </div>
            <div>
                ...
                <div class="item_2">
                  <img src="/img/business-areas/racks/solinda_racks-1.jpg" style="width: clamp(230px, 22vw + 1rem, 350px);" alt="Solinda"/>
                </div>
            </div>
          </div>
        </section>
        ...
        <div class="slider margin-twelve-bottom">
