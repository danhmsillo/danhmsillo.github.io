...
<html lang="<?php echo $lang['language']?>"><head>
  ...
  <link rel="canonical" href="http://www.solinda.com.mx/servicio_refaccionamiento.php?lang=es">
  <link rel="alternate" hreflang="en" href="http://www.solinda.com.mx/servicio_refaccionamiento.php?lang=en">
      ...
      <div class="main-content">
        ...
        <div class="wrapper-hero__service-each">
          <section class="page-hero" class="about-hero image-as-background">
              <div class="container text-center">
                ...
                <h2 class="hero-title animate fadeInLeft delay-600"><?php echo $lang['Refaccionamiento']?></h2>
              </div>
        ...
        <div class="service-each__hero-img">
          <div class="container">
            <span class="animate fadeInLeft delay-800">
              <img src="/img/service-each/components/solinda_components_cover.jpg" class="img-fluid" alt="SOLINDA — Refaccionamiento">
            </span>
          </div>
        </div>
        ...
        <!--<div class="service-page-cover-img animate fadeInLeft delay-800">
          ...
          <section class="service-each-paragraph">
            <div class="container">
              <div class="column_container">
                <div class="col">
                  <span class="mask notViewed animBlock item_1 label-line" data-position="up"><h6 class=""><?php echo $lang['Refaccionamiento']?></h6></span>
                  <p class="item_2 service__cover-paragraph">
                  <?php echo $lang['Utilizamos en ']?><span class="highlight"><?php echo $lang['Solinda']?></span><?php echo $lang[' tecnología de punta y centros de maquinado CNC para la ingeniería y la manufactura de refacciones y componentes de precisión.']?>
                  </p>
                  <p class="item_2"><?php echo $lang['Realizamos proyectos de maquinado de precisión para clientes de México y del extranjero, listos para satisfacer los requerimientos de ingeniería, manufactura y entrega.']?>
                  </p>
                </div>
              </div> 
            </div> 
          ...
          <div class="slider">
            ...
            <div class="swiper-slide"><img src="/img/service-each/components/solinda_components_s_01.jpg" alt="Solinda" class="img-fluid"></div>
            <div class="swiper-slide"><img src="/img/service-each/components/solinda_components_s_02.jpg" alt="Solinda" class="img-fluid"></div>
            <div class="swiper-slide"><img src="/img/service-each/components/solinda_components_s_03.jpg" alt="Solinda" class="img-fluid"></div>
            <div class="swiper-slide"><img src="/img/service-each/components/solinda_components_s_04.jpg" alt="Solinda" class="img-fluid"></div>
            <div class="swiper-slide"><img src="/img/service-each/components/solinda_components_s_05.jpg" alt="Solinda" class="img-fluid"></div>
              ...
              <div class="column_container">
                <div class="row">
                  <div class="col col-md-6">  
                    <span class="mask-fadein item_3 notViewed animBlock" data-position="in">
                      <div class="service-each__img " style="background-image:url(/img/service-each/components/solinda_component_02.jpg);"></div>
                    </span>
                  </div>
                  <div class="col col-md-5 col-md-offset-1">
                    ...
                    <span class="mask-fadein item_2 notViewed animBlock" data-position="in"><p class="item_5"><?php echo $lang['Estamos comprometidos con entregar solo la más alta calidad a cada cliente, por eso cada pieza es sometida a verificación de calidad en nuestro laboratorio de metrología con equipo certificado y personal experto.']?></p>
            ...
            <div class="container">
              <div class="column_container">
                <div class="row">
                  <div class="col col-md-5 ">  
                    <span class="mask notViewed animBlock item_1 label-line" data-position="up"></span>
                    <span class="mask-fadein item_3 notViewed animBlock" data-position="in"><p class="item_2"><?php echo $lang['Con nuestro equipo de primera fabricamos nuestros propios componentes para los dispositivos y para los proyectos complejos de automatización. Nuestra capacidad de manufactura indiscutiblemente nos hace más eficientes en calidad, costos y tiempo.']?></p></span>
                    <br><br><br>
                  </div>
                  <div class="col col-md-6 col-md-offset-1">
                    <span class="mask-fadein item_3 notViewed animBlock" data-position="in">
                      <div class="service-each__img item_3" style="background-image:url('/img/service-each/components/solinda_component_01.jpg"></div>
                    </span>
                  </div>
                </div>
              </div> 
