...
<html lang="<?php echo $lang['language']?>"><head>
  ...
  <link rel="canonical" href="http://www.solinda.com.mx/proyecto_celda-robotica-para-manejo-de-cabezas-de-motor.php?lang=es">
  <link rel="alternate" hreflang="en" href="http://www.solinda.com.mx/proyecto_celda-robotica-para-manejo-de-cabezas-de-motor.php?lang=en">
  ...
  <div id="wrapper">
    ...
    <div class="main-content">
      ...
      <div class="wrapper-hero__project-each">
        <section class="page-hero" class="about-hero image-as-background" style="background-image: url('img\projects\cortadora-ensamble-clips-2023\IMG_20210701_200136.jpg');">
            <div class="container">
              <h6 class="animate fadeInLeft delay-400"><span class="dash">—</span><?php echo $lang['Proyecto']?></h6>
              <h2 class="hero-title animate fadeInLeft delay-600"><?php echo $lang['Celda Robótica para Manejo de Cabezas de Motor']?></h2>
            </div>
      ...
      <div class="project-each__lg-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in">
            <img src="img\projects\cortadora-ensamble-clips-2023\IMG_20210701_200136.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in">
            <img src="img\projects\cortadora-ensamble-clips-2023\IMG_20210630_094914.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
