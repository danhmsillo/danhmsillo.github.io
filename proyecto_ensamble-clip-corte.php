...
<html lang="<?php echo $lang['language']?>"><head>
  ...
  <link rel="canonical" href="http://www.solinda.com.mx/proyecto_ensamble-clip-corte.php?lang=es">
  <link rel="alternate" hreflang="en" href="http://www.solinda.com.mx/proyecto_ensamble-clip-corte.php?lang=en">
  ...
  <div id="wrapper">
    ...
    <div class="main-content">
      ...
      <div class="wrapper-hero__project-each">
        <section class="page-hero" class="about-hero image-as-background" style="background-image: url('/img/projects/ensamble-clip/solinda_proj_ensamble-clip-corte_cover.jpg');">
            <div class="container">
              <h6 class="animate fadeInLeft delay-400"><span class="dash">—</span><?php echo $lang['Proyecto']?></h6>
              <h2 class="hero-title animate fadeInLeft delay-600"><?php echo $lang['Ensamble de Clips y Corte de Colada para Empresa Americana']?></h2>
            </div>
        ...
        <ul class="project__tags">
          ...
          <div class="project__tags__inner">
            <li class="project__tag" style="">
              ...
              <div class="project__tag__value"><?php echo $lang['Empresa Automotriz Americana']?></div>
            </li>
            <li class="project__tag" style="">
      ...
      <div class="project-each__lg-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/ensamble-clip/solinda_proj_ensamble-clip-corte_cover.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
        ...
        <div class="container">
          <div class="column_container ">
              <div class="col">  
                ...
                <p class="item_2 rich-paragraph"><?php echo $lang['Esta compleja línea de ensamble fue fabricada y automatizada enteramente por el equipo de Solinda en un tiempo récord de 14 semanas desde su concepción hasta su puesta en marcha.']?></p></br></br>
                <p class="item_2"><?php echo $lang['La línea está conformada por 10 estaciones, donde 5 de ellas están destinadas al ensamble de clips para Air Dam mientras que las otras 5 estaciones se encargan del corte de colada para fascias. Ambas líneas incluyen poka-yokes nivel 2 e igualmente incorporan un sistema de seguridad para el operario, como un botón bimanual y cortinas de seguridad de la marca Keyence.']?></p></br></br>
                <p class="item_2"><?php echo $lang['Las estaciones de ensamble de clips se integran por estructuras de PTR de 2”, placas base de acero a 36, nidos de Nylamid y aluminio, sistemas de clamps neumáticos de sujeción y cilindros neumáticos de inserción de la marca SMC, con sistema de magazine para acumulación de grapas.']?></p></br></br>
                <p class="item_2"><?php echo $lang['Por el otro lado, las estaciones de corte de colada para fascias se integran por estructuras de PTR de 2”, placas base de acero a 36, nidos de Nylamid y aluminio, sistemas de clamps neumáticos de sujeción marca SMC, corte por medio de navaja comercial, accionamiento por cilindro neumático marca SMC.']?></p></br></br>
                <p class="item_2"><?php echo $lang['Los dos tipos de máquina incorporan un sistema de trazabilidad a través de impresión de códigos QR con un escáner de última generación marca Keyence modelo RS 2000; esta característica permite confirmar el proceso de la pieza.']?></p></br></br>
                <p class="item_2"><?php echo $lang['Además, el sistema incluye un PLC y un HMI de 8” de la marca Allen-Bradley modelo Compact Logix, el sistema de clamps neumáticos de la marca SMC y sensores de presencia marca Balluf. ']?></p></br></br>
              </div>
          </div> 
        </div> 
      </section>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/ensamble-clip/solinda__ensamble-clip-corte-02.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_2" data-position="in"">
            <img src="/img/projects/ensamble-clip/solinda__ensamble-clip-corte-03.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/ensamble-clip/solinda__ensamble-clip-corte-04.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/ensamble-clip/solinda__ensamble-clip-corte-05.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
      ...
      <div class="project-each__info-img-wrapper">
        <div class="container">
          <span class="mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/projects/ensamble-clip/solinda__ensamble-clip-corte-06.jpg" class="img-regular img-fluid" alt="">
          </span>
        </div>
      </div>
