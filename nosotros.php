...
<html lang="<?php echo $lang['language']?>"><head>
  ...
  <link rel="canonical" href="http://www.solinda.com.mx/nosotros.php?lang=es">
  <link rel="alternate" hreflang="en" href="http://www.solinda.com.mx/nosotros.php?lang=en">
    ...
    <!--END HEADER -->
      ...
      <div class="main-content" id="about">
        ...
        <div class="wrapper-hero">
          <section class="page-hero" class="about-hero image-as-background" style="background-image: url('/img/about/about__cover.jpg');">
              <div class="container">
                <h6 class="animate fadeInLeft delay-400"><span class="dash">—</span><?php echo $lang['Acerca de Nosotros']?></h6>
                <h2 class="hero-title animate fadeInLeft delay-600"><?php echo $lang['Nacimos para dar Soluciones']?></h2>
                <p class="p-cover animate fadeInLeft delay-800"><?php echo $lang['Nos hemos convertido en una empresa líder, lista para seguir avanzando.']?></p>
              </div>
      ...
      <div id="about-page">    
        <!-- END HERO -->
        <section id="about-page__content">
          <div class="container text-center">
            <div class="column_container ">
                <div class="col">  
                  <span class="mask notViewed animBlock item_1 label-line" data-position="up"><h6 class=""><?php echo $lang['Nuestra Definición']?></h6></span>
                  <h3 class="item_2">
                    <?php echo $lang['Comenzamos operaciones en 2012 y desde entonces, guiados por la filosofía de mejora continua, en ']?><span class="highlight"><?php echo $lang['Solinda']?></span><?php echo $lang[' no hemos dejado de innovar.']?>
                  </h3>
                </div>
        ...
        <div class="slider">
          ...
          <div class="swiper-slide"><img src="/img/about/Solinda-img-10.jpg" alt="Solinda" class="img-fluid"></div>
          <div class="swiper-slide"><img src="/img/about/Solinda-img-08.jpg" alt="Solinda" class="img-fluid"></div>
          <div class="swiper-slide"><img src="/img/about/Solinda-img-07.jpg" alt="Solinda" class="img-fluid"></div>
          <div class="swiper-slide"><img src="/img/about/Solinda-img-09.jpg" alt="Solinda" class="img-fluid"></div>
          <div class="swiper-slide"><img src="/img/about/Solinda-img-10.jpg" alt="Solinda" class="img-fluid"></div>
          <div class="swiper-slide"><img src="/img/about/Solinda-img-06.jpg" alt="Solinda" class="img-fluid"></div>
            ...
            <div class="column_container">
              <div class="row">
                <div class="col col-md-6">  
                  <span class="mask notViewed animBlock item_1 label-line" data-position="up"><h6 class=""><span class="dash">—</span><?php echo $lang['Nuestro Equipo']?></h6></span>
                  <h3 class="item_2">
                  <?php echo $lang['Somos un equipo Apasionado y ']?><span class="highlight"><?php echo $lang['Talentoso']?></span>
                  </h3>
                  <p class="item_2"><?php echo $lang['Nuestros ingenieros, profesionales y técnicos tienen la experiencia y el conocimiento para los retos que enfrentamos día a día. Pero más que eso, tiene el compromiso y la pasión que nos han convertido en un equipo reconocido como líder de nuestro sector.']?></p>
                </div>
                <div class="col col-md-5 col-md-offset-1 ">
                  <span class="mask-fadein item_5 notViewed animBlock" data-position="in">
                    <div>
                      <img src="/img/about/Solinda__about-01.jpg" alt="" class="img-about img-fluid">
                    </div>
                  </span>
                </div>
              </div> 
                ...
                <div class="col col-md-8">
                  <span class="mask-fadein item_4 notViewed animBlock" data-position="in">
                    <div class="home-stats">
                      <ul>
                        <li>
                          <span class="number" data-count="65">65</span>
                          <span class="label-stat"><?php echo $lang['Miembros de Solinda']?></span>
                        </li>
                        <li>
                          <span class="number" data-count="10">10</span>
                          <span class="label-stat"><?php echo $lang['Ingenieros Mecánicos']?></span>
                        </li>
                        <li>
                          <span class="number" data-count="10">10</span>
                          <span class="label-stat"><?php echo $lang['Líderes de departamento']?></span>
                        </li>
                      </ul>
                    </div>
                  </span>
        ...
        <div class="container">
          <span class="machinery-img mask-fadein notViewed animBlock item_4" data-position="in"">
            <img src="/img/about/Solinda__about-02.jpg" class="img-translate-up img-fluid" alt="">
          </span>
        </div>

        <section id="machinery_about">
          <div class="container"> 
            <div class="row">
            <span class="mask notViewed animBlock item_1 label-line" data-position="up"><h6 class=""><?php echo $lang['Maquinaria']?></h6></span>
            <h3 class="item_2">
            <?php echo $lang['Maquinaria de ']?><span class="highlight"><?php echo $lang['Vanguardia']?></span>
            </h3>
            </div>
            <div class="cta_container mask-fadein item_3 notViewed animBlock" data-position="in">
              <a class="cta2" href="maquinaria-lista.php" title="discover" target="_self">
                <span><?php echo $lang['Ver Lista de Maquinaria']?></span>
              ...
              <div class="col">
                <span class="mask-fadein item_4 notViewed animBlock" data-position="in">
                  <div class="machinery-features">
                    <ul>
                      <li class="item_5">
                        <span class="machine_name"><?php echo $lang['20 Centros CNC']?></span>
                        <span class="machine_label"></span>
                      </li>
                      <li class="item_6">
                        <span class="machine_name"><?php echo $lang['CNC de 5 Ejes']?></span>
                        <span class="machine_label"></span>
                      </li>
                      <li>
                        <span class="machine_name"><?php echo $lang['2 CNC de Puente']?></span>
                        <span class="machine_label"></span>
                      </li>
                      <li>
                        <span class="machine_name"><?php echo $lang['Dobladora de Lámina CNC']?></span>
                        <span class="machine_label"></span>
                      </li>
                      <li>
                        <span class="machine_name"><?php echo $lang['Cortadora Láser de 8m']?></span>
                        <span class="machine_label"></span>
                      </li>
                      <li>
                        <span class="machine_name"><?php echo $lang['Grúa de 10 toneladas']?></span>
                        <span class="machine_label"></span>
                      </li>
                    </ul>
                  </div>
        ...
        <div class="slider">
          ...
          <div class="swiper-slide"><img src="/img/about/solinda_machinery_s-05.jpg" alt="Solinda" class="img-fluid"></div>
          <div class="swiper-slide"><img src="/img/about/solinda_machinery_s-04.jpg" alt="Solinda" class="img-fluid"></div>
          <div class="swiper-slide"><img src="/img/about/solinda_machinery_s-03.jpg" alt="Solinda" class="img-fluid"></div>
          <div class="swiper-slide"><img src="/img/about/solinda_machinery_s-02.jpg" alt="Solinda" class="img-fluid"></div>
          <div class="swiper-slide"><img src="/img/about/solinda_machinery_s-01.jpg" alt="Solinda" class="img-fluid"></div>
          </div>
          <div class="swiper-pagination"></div>
          <div class="swiper-button-prev"></div>
          <div class="swiper-button-next"></div>
